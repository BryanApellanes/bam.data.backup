...
namespace Bam.Net.Data.Repositories // shared
{
	public partial class BackedupDatabase: Database
	{
		...
		public new IDaoTransaction BeginTransaction()
		{
		...
		public override void ExecuteSql(ISqlStringBuilder builder)
		{
		...
		public new void ExecuteSql<T>(ISqlStringBuilder builder) where T : Dao
		{
